...
rem '-g', '--gens', metavar='INT', type=int, default=START_GENS_PER_SEC, help='startup number of generations per sec, between MIN_GENS_PER_SEC and MAX_GENS_PER_SEC', required=False
